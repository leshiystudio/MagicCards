...
**Версия:** 0.13 · **Дата:** 16.09.2026 · **Статус:** исходная спецификация; код ещё не реализован.
...
**Рабочие допущения v0.12:** TypeScript и браузерный стек; ограниченная модель блоков; числа баланса, размеры колод/руки, правила производства/хранения и стартовые карты ниже. Это предложения для старта, а не ранее утверждённые решения. Их изменения оформляются следующей редакцией.
...
|---|---|---|
| E0 | Спецификация 0.12 | Контракты ядра, библиотека способностей, события/фишки/лимит поля/жетоны эффектов/оба режима экономики/составные типы/чары/Сила/перемещения, E8/P1, бот, мастерская, колоды и PR описаны; конвертеры/сеть не расширяют первый выпуск |
...
| E8b | Интеграция полного состава ядра | Оба режима экономики, чары/Сила/броня/жетоны/воскрешение, взаимодействия и все сценарии приёмки E8; replay и по 100 прогонов бота на режим |
